...
from .views import (
    PressureSensorViewSet,
    PressureSensorViewSet2,
    Pressure_ReadingView,
    Pressure_SensorHTTPView,
)
...
urlpatterns = [
    path(
        "pressure-generic/",
        PressureSensorViewSet.as_view({"get": "list"}),
        name="pressuresensorhttpcreated",
    ),
